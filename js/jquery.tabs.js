        ...
        accessibleTabs: function( config ) {
            ...
            return this.each( function( ) {
                ...
                var contentAnchor 	= o.getUniqueId( 'accessibletabscontent' ),
               		tabsAnchor		= o.getUniqueId( 'accessibletabs' );
                ...
                el.find( options.tabhead ).each( function( i ) {
                    ...
                    list += '<li><a' + id + ' href="#' + contentAnchor + '">' + el.text() + '</a></li>';
                    el.remove();
                    tabCount++;
                } );
                ...
                el.find( options.tabbody + ':first' )
                  .show()
                  .before( '<' + options.tabhead + '><a tabindex="0" class="accessibletabsanchor" name="' + contentAnchor + '" id="' + contentAnchor + '">' + el.find( "ul>li:first" ).text() + '</a></' + options.tabhead + '>' );
                el.find( "ul>li:first" )
                ...
                el.find( 'ul.' + options.tabsListClass + '>li>a' ).each( function( i ) {
                    $( this ).click( function( event ) {
                        ...
                        el.find( 'ul>li.' + options.currentClass )
                          .removeClass( options.currentClass )
                          .find("span." + options.currentInfoClass )
                          .remove();
                        $( this ).blur();
                        el.find( options.tabbody + ':visible' )
                          .hide();
                        el.find( options.tabbody )
                          .eq( i )[ options.fx ]( options.fxspeed );
